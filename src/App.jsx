...
const initialEmployees = [
  // ── Cardiology (5) ────────────────────────────────────────────────────────
  { id: 1,  name: 'Dr. Sarah Johnson',    role: 'Chief Medical Officer',    department: 'Cardiology',     performance: 95, competency: 92, training: 98, managerEmployeeId: null, qualifications: 'MD, Board Certified Cardiologist, PRC Lic. No. 0012345', employmentStatus: 'Regular',      dateHired: '2018-03-01', competencyNotes: 'Consistently exceeds expectations. Strong leadership and clinical acumen. Identified as key succession candidate for CMO.' },
  { id: 2,  name: 'Dr. Michael Chen',     role: 'Cardiologist',             department: 'Cardiology',     performance: 91, competency: 88, training: 90, managerEmployeeId: 1,    qualifications: 'MD, Fellow Philippine College of Cardiology, PRC Lic. No. 0023456', employmentStatus: 'Regular', dateHired: '2019-06-15', competencyNotes: 'High performer. Leadership skills developing well. Enrolled in advanced cardiac program.' },
  { id: 3,  name: 'Dr. Ana Reyes',        role: 'Cardiologist',             department: 'Cardiology',     performance: 87, competency: 84, training: 88, managerEmployeeId: 1,    qualifications: 'MD, Diplomate Philippine College of Cardiology, PRC Lic. No. 0034567', employmentStatus: 'Regular', dateHired: '2020-08-10', competencyNotes: 'Solid clinical skills. Communication gap noted during peer reviews — enrolled in communication workshop.' },
  { id: 4,  name: 'Nurse Patricia Lim',   role: 'Senior Cardiac Nurse',     department: 'Cardiology',     performance: 89, competency: 86, training: 93, managerEmployeeId: 2,    qualifications: 'BSN, RN, Critical Care Certified, PRC Lic. No. 0045678', employmentStatus: 'Regular',    dateHired: '2019-11-20', competencyNotes: 'Exceptional patient care scores. Strong mentor for junior nurses.' },
  { id: 5,  name: 'Nurse Carlo Santos',   role: 'Registered Nurse',         department: 'Cardiology',     performance: 76, competency: 72, training: 78, managerEmployeeId: 4,    qualifications: 'BSN, RN, PRC Lic. No. 0056789', employmentStatus: 'Probationary',                          dateHired: '2025-03-01', competencyNotes: 'Probationary period — needs improvement in clinical compliance and documentation accuracy.' },
  // ── Nursing (4) ───────────────────────────────────────────────────────────
  { id: 6,  name: 'James Wilson',         role: 'Head Nurse',               department: 'Nursing',        performance: 90, competency: 87, training: 94, managerEmployeeId: 1,    qualifications: 'BSN, RN, MSN (Healthcare Management), PRC Lic. No. 0067890', employmentStatus: 'Regular',    dateHired: '2018-05-15', competencyNotes: 'Strong leadership. Manages nursing roster effectively. Recommended for succession planning.' },
  { id: 7,  name: 'Maria Garcia',         role: 'Senior Nurse',             department: 'Nursing',        performance: 86, competency: 84, training: 88, managerEmployeeId: 6,    qualifications: 'BSN, RN, PRC Lic. No. 0078901', employmentStatus: 'Regular',                                dateHired: '2020-01-10', competencyNotes: 'Reliable, detail-oriented. High patient satisfaction scores consistently.' },
  { id: 8,  name: 'Nurse Joy dela Cruz',  role: 'Registered Nurse',         department: 'Nursing',        performance: 82, competency: 79, training: 85, managerEmployeeId: 6,    qualifications: 'BSN, RN, PRC Lic. No. 0089012', employmentStatus: 'Regular',                                dateHired: '2021-07-01', competencyNotes: 'Good overall. Digital literacy gap identified — enrolled in Health IT workshop.' },
  { id: 9,  name: 'Nurse Ramon Torres',   role: 'Registered Nurse',         department: 'Nursing',        performance: 74, competency: 70, training: 76, managerEmployeeId: 6,    qualifications: 'BSN, RN, PRC Lic. No. 0090123', employmentStatus: 'Regular',                                dateHired: '2022-02-14', competencyNotes: 'Performance below target for Q2. Enrolled in mandatory patient safety refresher. Supervisor monitoring closely.' },
  // ── Pediatrics (3) ────────────────────────────────────────────────────────
  { id: 10, name: 'Dr. Lisa Anderson',    role: 'Chief Pediatrician',       department: 'Pediatrics',     performance: 93, competency: 91, training: 96, managerEmployeeId: 1,    qualifications: 'MD, Diplomate Philippine Pediatric Society, PRC Lic. No. 0101234', employmentStatus: 'Regular', dateHired: '2017-09-01', competencyNotes: 'Top performer. Excellent clinical and leadership scores. High succession readiness.' },
  { id: 11, name: 'Dr. Ben Uy',           role: 'Pediatrician',             department: 'Pediatrics',     performance: 85, competency: 82, training: 87, managerEmployeeId: 10,   qualifications: 'MD, Fellow Philippine Pediatric Society, PRC Lic. No. 0112345', employmentStatus: 'Regular',    dateHired: '2021-04-12', competencyNotes: 'Strong pediatric skills. Leadership development ongoing — enrolled in seminar series.' },
  { id: 12, name: 'Nurse Teresa Ocampo',  role: 'Pediatric Nurse',          department: 'Pediatrics',     performance: 88, competency: 85, training: 91, managerEmployeeId: 10,   qualifications: 'BSN, RN, Pediatric Nursing Certification, PRC Lic. No. 0123456', employmentStatus: 'Regular',  dateHired: '2019-03-20', competencyNotes: 'Exceptional with pediatric patients. Peer-recognized for compassionate care.' },
  // ── Laboratory (3) ────────────────────────────────────────────────────────
  { id: 13, name: 'Emily Brown',          role: 'Laboratory Director',      department: 'Laboratory',     performance: 88, competency: 85, training: 90, managerEmployeeId: 1,    qualifications: 'BS Medical Technology, RMT, MS Clinical Laboratory Science, PRC Lic. No. 0134567', employmentStatus: 'Regular', dateHired: '2018-08-01', competencyNotes: 'Strong technical expertise. AI literacy gap identified relative to lab data systems — prioritize upskilling.' },
  { id: 14, name: 'Mark Navarro',         role: 'Medical Technologist',     department: 'Laboratory',     performance: 83, competency: 80, training: 84, managerEmployeeId: 13,   qualifications: 'BS Medical Technology, RMT, PRC Lic. No. 0145678', employmentStatus: 'Regular',               dateHired: '2020-11-03', competencyNotes: 'Consistent performer. Compliance with new lab protocols improving after training.' },
  { id: 15, name: 'Grace Mendoza',        role: 'Laboratory Technician',    department: 'Laboratory',     performance: 78, competency: 75, training: 80, managerEmployeeId: 13,   qualifications: 'BS Medical Technology, RMT, PRC Lic. No. 0156789', employmentStatus: 'Contractual',            dateHired: '2024-06-01', competencyNotes: 'Contractual staff — strong work ethic but needs additional training on automated lab systems.' },
  // ── Radiology (2) ─────────────────────────────────────────────────────────
  { id: 16, name: 'Dr. Raymond Cruz',     role: 'Radiologist',              department: 'Radiology',      performance: 90, competency: 88, training: 92, managerEmployeeId: 1,    qualifications: 'MD, Diplomate Philippine College of Radiology, PRC Lic. No. 0167890', employmentStatus: 'Regular', dateHired: '2019-01-15', competencyNotes: 'Excellent diagnostic accuracy. High AI readiness — leads department on digital imaging adoption.' },
  { id: 17, name: 'Jessa Villanueva',     role: 'Radiologic Technologist',  department: 'Radiology',      performance: 85, competency: 82, training: 87, managerEmployeeId: 16,   qualifications: 'BS Radiologic Technology, RT, PRC Lic. No. 0178901', employmentStatus: 'Regular',             dateHired: '2021-09-06', competencyNotes: 'Reliable and accurate. Enrolled in advanced CT/MRI techniques certification.' },
  // ── Administration (3) ────────────────────────────────────────────────────
  { id: 18, name: 'David Martinez',       role: 'HR Director',              department: 'Administration', performance: 84, competency: 81, training: 86, managerEmployeeId: 1,    qualifications: 'BS Psychology, MBA Human Resource Management, SHRM-CP', employmentStatus: 'Regular',            dateHired: '2018-11-15', competencyNotes: 'Effective HR operations. Data literacy gap noted — would benefit from HR analytics training.' },
  { id: 19, name: 'Robert Taylor',        role: 'Hospital Administrator',   department: 'Administration', performance: 86, competency: 83, training: 88, managerEmployeeId: 1,    qualifications: 'BS Business Administration, MHA (Master of Hospital Administration)', employmentStatus: 'Regular', dateHired: '2019-05-20', competencyNotes: 'Strong administrative competencies. Leading digital transformation initiative for the hospital.' },
  { id: 20, name: 'Anna Castillo',        role: 'HR Coordinator',           department: 'Administration', performance: 80, competency: 77, training: 82, managerEmployeeId: 18,   qualifications: 'BS Psychology, HR Management Certificate', employmentStatus: 'Regular',                        dateHired: '2022-04-11', competencyNotes: 'Good foundational HR skills. Developing competency in HRIS systems and data-driven HR practices.' },
]

const initialTrainingPrograms = [
  { id: 1,  title: 'Advanced Cardiac Life Support (ACLS)',      type: 'Certification', duration: '2 days',   participants: 12, seats: 15, status: 'upcoming',  instructor: 'Dr. Michael Chen',     cost: 250, date: '2026-07-08', time: '8:00 AM - 5:00 PM',  location: 'Conference Hall',   competencyIds: [1] },
  { id: 2,  title: 'Emergency Response and Triage Protocols',   type: 'Workshop',      duration: '8 hours',  participants: 18, seats: 20, status: 'ongoing',   instructor: 'Dr. Raymond Cruz',     cost: 0,   date: '2026-07-05', time: '9:00 AM - 4:00 PM',  location: 'Training Room A',   competencyIds: [1, 4] },
  { id: 3,  title: 'Patient Safety and Quality Improvement',    type: 'Course',        duration: '3 hours',  participants: 20, seats: 20, status: 'completed', instructor: 'Nurse Patricia Lim',   cost: 0,   date: '2026-06-20', time: '2:00 PM - 5:00 PM',  location: 'Training Room B',   competencyIds: [4] },
  { id: 4,  title: 'Leadership Excellence in Healthcare',       type: 'Seminar',       duration: '1 day',    participants:  8, seats: 12, status: 'upcoming',  instructor: 'Dr. Sarah Johnson',    cost: 150, date: '2026-07-12', time: '9:00 AM - 5:00 PM',  location: 'Boardroom',         competencyIds: [3] },
  { id: 5,  title: 'Healthcare Data Analytics Fundamentals',    type: 'Course',        duration: '6 hours',  participants:  5, seats: 20, status: 'upcoming',  instructor: 'David Martinez',       cost: 100, date: '2026-07-18', time: '9:00 AM - 3:00 PM',  location: 'Computer Lab',      competencyIds: [5, 6] },
  { id: 6,  title: 'Digital Literacy for Clinical Staff',       type: 'Workshop',      duration: '4 hours',  participants: 10, seats: 25, status: 'upcoming',  instructor: 'Anna Castillo',        cost: 0,   date: '2026-07-22', time: '1:00 PM - 5:00 PM',  location: 'Computer Lab',      competencyIds: [5] },
  { id: 7,  title: 'Infection Control and Prevention',          type: 'Course',        duration: '3 hours',  participants: 20, seats: 20, status: 'completed', instructor: 'Dr. Ana Reyes',        cost: 0,   date: '2026-06-10', time: '10:00 AM - 1:00 PM', location: 'Training Room A',   competencyIds: [4] },
  { id: 8,  title: 'Communication and Interpersonal Skills',    type: 'Workshop',      duration: '5 hours',  participants:  6, seats: 15, status: 'upcoming',  instructor: 'Robert Taylor',        cost: 75,  date: '2026-07-25', time: '9:00 AM - 2:00 PM',  location: 'Training Room B',   competencyIds: [2] },
  { id: 9,  title: 'AI in Healthcare: Practical Introduction',  type: 'Seminar',       duration: '4 hours',  participants:  4, seats: 20, status: 'upcoming',  instructor: 'Dr. Raymond Cruz',     cost: 120, date: '2026-08-01', time: '1:00 PM - 5:00 PM',  location: 'Conference Hall',   competencyIds: [6, 5] },
  { id: 10, title: 'Basic Life Support (BLS) Recertification',  type: 'Certification', duration: '4 hours',  participants: 15, seats: 15, status: 'completed', instructor: 'Dr. Ben Uy',           cost: 80,  date: '2026-06-05', time: '8:00 AM - 12:00 PM', location: 'Simulation Lab',    competencyIds: [1, 4] },
]

const initialCompetencies = [
  { id: 1, name: 'Clinical Expertise',    description: 'Depth of medical and clinical knowledge and technical proficiency', category: 'Technical Skills',   weight: 30 },
  { id: 2, name: 'Communication',         description: 'Effective communication with patients, families, and colleagues',    category: 'Soft Skills',        weight: 20 },
  { id: 3, name: 'Leadership',            description: 'Ability to lead teams, mentor staff, and drive outcomes',            category: 'Leadership',         weight: 25 },
  { id: 4, name: 'Regulatory Compliance', description: 'Adherence to DOH, PRC, and institutional safety standards',         category: 'Compliance',         weight: 25 },
  { id: 5, name: 'Digital Literacy',      description: 'Proficiency with health information and digital systems',            category: 'Technical Skills',   weight: 15 },
  { id: 6, name: 'Data & AI Literacy',    description: 'Ability to interpret healthcare data and apply AI-assisted tools',  category: 'Technical Skills',   weight: 15 },
]

const initialRecognitionAwards = [
  { id: 1,  recipient: 'Dr. Sarah Johnson',   type: 'Employee of the Month',    department: 'Cardiology',     date: '2026-06-15', reason: 'Exceptional leadership during the cardiac care unit expansion project.',                             giver: 'Administrator',    peer: false, likes: 8,  comments: [{ author: 'James Wilson',  text: 'Well deserved!',             at: '2026-06-15 10:30 AM' }] },
  { id: 2,  recipient: 'James Wilson',         type: 'Patient Care Champion',    department: 'Nursing',        date: '2026-06-18', reason: 'Consistent excellence in patient advocacy and compassionate nursing practice.',                      giver: 'Dr. Sarah Johnson', peer: false, likes: 12, comments: [{ author: 'Maria Garcia', text: 'Truly an inspiration to us all.', at: '2026-06-18 2:15 PM' }] },
  { id: 3,  recipient: 'Emily Brown',          type: 'Innovation Award',         department: 'Laboratory',     date: '2026-06-20', reason: 'Streamlined laboratory workflow reducing result turnaround time by 30%.',                           giver: 'David Martinez',   peer: false, likes: 7,  comments: [] },
  { id: 4,  recipient: 'Dr. Raymond Cruz',     type: 'Excellence in Practice',   department: 'Radiology',      date: '2026-06-22', reason: 'Pioneered AI-assisted imaging diagnostics, raising departmental accuracy to 98.5%.',               giver: 'Administrator',    peer: false, likes: 10, comments: [{ author: 'Dr. Lisa Anderson', text: 'Remarkable innovation!', at: '2026-06-22 9:00 AM' }] },
  { id: 5,  recipient: 'Nurse Teresa Ocampo',  type: 'Peer Recognition',         department: 'Pediatrics',     date: '2026-06-25', reason: 'Outstanding support for pediatric patients during the busy flu season.',                           giver: 'Dr. Lisa Anderson', peer: true,  likes: 15, comments: [] },
  { id: 6,  recipient: 'Dr. Lisa Anderson',    type: 'Excellence Award',         department: 'Pediatrics',     date: '2026-06-28', reason: 'Highest patient satisfaction scores in the hospital for Q2 2026 — 99.1% rating.',                  giver: 'Administrator',    peer: false, likes: 11, comments: [{ author: 'Dr. Ben Uy', text: 'Great mentor and clinician.', at: '2026-06-28 11:00 AM' }] },
  { id: 7,  recipient: 'Mark Navarro',         type: 'Peer Recognition',         department: 'Laboratory',     date: '2026-07-01', reason: 'Stayed late three times this week to ensure urgent lab results were delivered on time.',              giver: 'Emily Brown',      peer: true,  likes: 6,  comments: [] },
  { id: 8,  recipient: 'Nurse Patricia Lim',   type: 'Mentor of the Quarter',    department: 'Cardiology',     date: '2026-07-02', reason: 'Dedicated mentorship to two probationary nurses, both of whom exceeded their 90-day targets.',     giver: 'James Wilson',     peer: true,  likes: 9,  comments: [] },
]

const initialSuccessionCandidates = [
  { id: 1, currentRole: 'Chief Medical Officer',   readiness: 'High',   timeline: '18-24 months', candidates: ['Dr. Michael Chen', 'Dr. Lisa Anderson'], devPlan: 'Executive leadership training, hospital board exposure, financial management orientation.' },
  { id: 2, currentRole: 'Head Nurse',              readiness: 'High',   timeline: '12-18 months', candidates: ['Maria Garcia', 'Nurse Patricia Lim'],     devPlan: 'Nursing management certification, conflict resolution training, budget management exposure.' },
  { id: 3, currentRole: 'Laboratory Director',     readiness: 'Medium', timeline: '24-36 months', candidates: ['Mark Navarro'],                            devPlan: 'Laboratory management course, quality assurance certification, leadership seminar series.' },
  { id: 4, currentRole: 'Chief Pediatrician',      readiness: 'High',   timeline: '12 months',    candidates: ['Dr. Ben Uy'],                              devPlan: 'Department head training, budget planning workshop, medical staff committee participation.' },
  { id: 5, currentRole: 'HR Director',             readiness: 'Medium', timeline: '24 months',    candidates: ['Anna Castillo', 'Robert Taylor'],          devPlan: 'Advanced HR analytics certification, organizational development training, strategic planning workshop.' },
]
...
const initialAnnouncements = [
  { id: 1, title: 'IHIMS Portal Now Live',                    body: 'We are pleased to launch the AI-Driven Human Resource Management System. All staff are encouraged to explore the modules and complete their self-assessment in the Performance Reviews section.',                                      category: 'General',  author: 'Administrator', date: '2026-06-01', pinned: true },
  { id: 2, title: 'Mandatory Emergency Response Drill',       body: 'All clinical staff must attend the emergency response drill on July 5 from 9:00 AM to 4:00 PM in Training Room A. Attendance is compulsory. Please register in the Learning module.',                                              category: 'Safety',   author: 'HR Director',   date: '2026-06-20', pinned: true },
  { id: 3, title: 'ACLS Certification Window Open',           body: 'Enrollment for the Advanced Cardiac Life Support certification is now open. Limited to 15 seats — register early in the Learning module. Priority given to Cardiology and Emergency department staff.',                               category: 'Training', author: 'HR Director',   date: '2026-06-25', pinned: false },
  { id: 4, title: 'Q2 Performance Review Cycle Now Open',     body: 'The Q2 2026 performance review cycle is open. All staff must complete their self-assessment by July 15. Department heads must submit manager reviews by July 22. Access the Performance Reviews module to participate.',            category: 'Policy',   author: 'HR Director',   date: '2026-07-01', pinned: false },
  { id: 5, title: 'New AI Literacy Training Available',       body: 'A new seminar on AI in Healthcare is scheduled for August 1. This training is highly recommended for all department heads and senior clinical staff as part of the hospital\'s digital transformation roadmap.',                     category: 'Training', author: 'Administrator', date: '2026-07-03', pinned: false },
  { id: 6, title: 'Updated Patient Data Privacy Guidelines',  body: 'In compliance with Republic Act No. 10173 (Data Privacy Act of 2012), updated patient data handling guidelines have been issued. All staff must review the updated protocol available from the HR office.',                          category: 'Policy',   author: 'HR Director',   date: '2026-07-05', pinned: false },
]

// Attendance record: { id, employeeId, date, status: 'Present'|'Absent'|'Late'|'Leave', notes }
const initialAttendance = [
  { id: 1,  employeeId: 5,  date: '2026-07-01', status: 'Late',    notes: 'Arrived 35 minutes late — traffic incident reported.' },
  { id: 2,  employeeId: 9,  date: '2026-07-01', status: 'Absent',  notes: 'Called in sick — fever.' },
  { id: 3,  employeeId: 15, date: '2026-07-01', status: 'Present', notes: '' },
  { id: 4,  employeeId: 5,  date: '2026-07-02', status: 'Late',    notes: 'Second late arrival this week.' },
  { id: 5,  employeeId: 9,  date: '2026-07-02', status: 'Leave',   notes: 'Sick leave — medical certificate submitted.' },
  { id: 6,  employeeId: 20, date: '2026-07-03', status: 'Late',    notes: 'Arrived 15 minutes late.' },
]
